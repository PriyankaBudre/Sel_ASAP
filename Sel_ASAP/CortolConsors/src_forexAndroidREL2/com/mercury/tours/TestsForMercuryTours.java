...
public class TestsForMercuryTours {
  ...
  public void beforeClass() throws IOException
  {
	  ...
	  Global.Environment.put("CLASSNAME", className);		
	   ...
	   //Initiate WebDriver
	   Global.webDriver = (AndroidDriver) asapDriver.fGetWebDriver();
...
//	   
//	   //Create object of TestForTransfer Application class
...
//		AssertJUnit.assertNotNull(mercuryHomePage, "Assert Mercury Home Page object is not null");
//		 
//	     //Check whether required page is opened
//	     AssertJUnit.assertTrue(objCommon.fValidatePageDisplayed("Welcome: Mercury Tours"), "Validate title : Welcome: Mercury Tours");
//		
//		//Click on the register link that returns RegisterUserObject
//		RegisterUser registerUser = mercuryHomePage.clickRegister();    
//		
//		//if the returned object is null then return false
//		AssertJUnit.assertNotNull(registerUser, "Assert Register User Page object is not null");
//
//		
//	    //Check whether required page is opened
//		AssertJUnit.assertTrue(objCommon.fValidatePageDisplayed("Register: Mercury Tours"), "Validate title : Register: Mercury Tours");      
//      
...
//
//		//if the returned object is null then return false
//	     AssertJUnit.assertNotNull(registerUserResultPage, "Assert Register User Result Page object is not null");	   		 		   
//   }
