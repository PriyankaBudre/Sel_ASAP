...
@Test public class ConfirmedOps {
	...
	//Define the constructor
		...
		public void DeleteConfirmed() throws MalformedURLException 
		  {
...
//			  login.ForexID();
			...
			//navigation to Unconfirmed screen
			  objCommon.fGuiClick(CONFIRMED);
			  objCommon.fGuiLongPress(ENTRY);
			  objCommon.fGuiClick(DELETE);
			  objCommon.fGuiClick(ALL);
		  }
