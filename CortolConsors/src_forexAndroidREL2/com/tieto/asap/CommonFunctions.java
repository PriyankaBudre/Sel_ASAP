...
public class CommonFunctions {
	...
	// ** boolean fGuiCheckChildObjectExistence(WebElement Parent, String
	// strDesc)
	// ** boolean fGuiCheckChildObjectNonExistence(WebElement Parent, String
	// strDesc)
	...
	public CommonFunctions() {
		...
		/*
		 * if(System.getProperty("os.name").equals("Windows 7")){ this.driver =
		 * Global.androidDriver; }else this.driver=Global.iosDriver ;
		 */
	}
	...
	public boolean fGuiCheckObjectExistence(String strDesc) {
		...
		try {
			...
			if (strElement.equalsIgnoreCase("linktext")) {
				...
				Reporter.fnWriteToHtmlOutput("Check Existence of object "
						+ strDesc, "Object should exist", "Property " + FindBy
						+ " specified for object is invalid", "Fail");
				System.out.println("Property name " + FindBy
						+ " specified for object " + strDesc + " is invalid");
				return false;
			}

			if (lst.size() > 0) {
				Reporter.fnWriteToHtmlOutput("Check Existence of object "
						+ strDesc, "Object Should exist", "Object Exist",
						"Pass");
				return true;
			} else {
				Reporter.fnWriteToHtmlOutput("Check Existence of object "
						+ strDesc, "Object Should exist",
		...
		// Catch Block
			...
			Reporter.fnWriteToHtmlOutput(
					"Check Existence of object " + strDesc,
					"Object should exist",
	...
	// * Return Values : Boolean - Depending on the success
	// *****************************************************************************************
	public boolean fGuiCheckChildObjectExistence(WebElement objParent,
			String strDesc) {
		// Delimiters
		String[] delimiters = new String[] { ":=" };
		String[] arrFindByValues = strDesc.split(delimiters[0]);
		...
		try {
			...
			if (strElement.equalsIgnoreCase("linktext")) {
				...
				Reporter.fnWriteToHtmlOutput("Check Existence of child object "
						+ strDesc, "Object should exist", "Property " + FindBy
						+ " specified for object is invalid", "Fail");
				System.out.println("Property name " + FindBy
						+ " specified for object " + strDesc + " is invalid");
			...
			if (lst.size() > 0) {
				// Reporter.fnWriteToHtmlOutput("Check Existence of child object "
				// + strDesc, "Object Should exist", "Object Exist", "Pass");
				return true;
			} else {
				// Reporter.fnWriteToHtmlOutput("Check Existence of child object "
				// + strDesc, "Object Should exist", "Object does not exist",
				// "Fail");
				return false;
			}
	...
	// * Return Values : Boolean - Depending on the success
	// *****************************************************************************************
	public boolean fGuiCheckChildObjectNonExistence(WebElement objParent,
			String strDesc) {
		// Delimiters
		String[] delimiters = new String[] { ":=" };
		String[] arrFindByValues = strDesc.split(delimiters[0]);
		...
		try {
			...
			if (strElement.equalsIgnoreCase("linktext")) {
				...
				Reporter.fnWriteToHtmlOutput(
						"Check object Non Existence for child object "
								+ strDesc, "Object should not exist",
						"Property " + FindBy
								+ " specified for object is invalid", "Fail");
				System.out.println("Property name " + FindBy
						+ " specified for object " + strDesc + " is invalid");
			...
			if (lst.size() == 0) {
				Reporter.fnWriteToHtmlOutput(
						"Check Non Existence of child object " + strDesc,
						"Object Should not exist", "Object does not exist",
						"Pass");
				return true;
			} else {
				Reporter.fnWriteToHtmlOutput(
						"Check Non Existence of child object " + strDesc,
						"Object Should not exist", "Object exist", "Fail");
				return false;
			}
		...
		// Catch Block
			...
			Reporter.fnWriteToHtmlOutput("Check Non Existence of child object "
					+ strDesc, "Object should not exist",
					"Exception occured while checking existence", "Fail");
			System.out.println("Exception " + e.toString()
					+ " occured while checking object non existence");
			return false;
		}
	}
	...
	public boolean fGuiCheckObjectNonExistence(String strDesc) {
		...
		try {
			...
			if (strElement.equalsIgnoreCase("linktext")) {
				...
				Reporter.fnWriteToHtmlOutput(
						"Check object Non Existence for object " + strDesc,
						"Object should not exist", "Property " + FindBy
								+ " specified for object is invalid", "Fail");
				System.out.println("Property name " + FindBy
						+ " specified for object " + strDesc + " is invalid");
				return false;
			...
			if (lst.size() == 0) {
				Reporter.fnWriteToHtmlOutput("Check Non Existence of object "
						+ strDesc, "Object Should not exist",
						"Object does not exist", "Pass");
				return true;
			} else {
				Reporter.fnWriteToHtmlOutput("Check Non Existence of object "
						+ strDesc, "Object Should not exist", "Object exist",
						"Fail");
				return false;
			}
			...
			if (bIsDisplayed) {
				Reporter.fnWriteToHtmlOutput(
						"Check if object with description  " + strDesc
								+ " is displayed",
						"Object should be displayed", "Object is Displayed",
						"Pass");
				return true;
			} else {
				Reporter.fnWriteToHtmlOutput(
						...
						"Object is not displayed", "Fail");
				return false;
			}

		} catch (Exception e) {
			Reporter.fnWriteToHtmlOutput("Check if element with description  "
		...
		try {
			...
			if (bNotIsDisplayed) {
				Reporter.fnWriteToHtmlOutput(
						"Check if object with description  " + strDesc
								+ " is not displayed",
						"Object should not be displayed",
						"Object is not displayed", "Pass");
				return true;
			} else {
				Reporter.fnWriteToHtmlOutput(
						"Check if object with description  " + strDesc
	...
	// * Author : Surbhi Shivhare
	// * Input Params : strDesc - The property of the object which is expected
	// to be enabled
	// * Return Values : Boolean - Depending on the success
	// *****************************************************************************************
	public boolean fGuiIsEnabled(String strDesc) {
		try {
			...
			if (!(bIsEnabled)) {
				Reporter.fnWriteToHtmlOutput(
						"Check if object with description  " + strDesc
								+ " is enabled", "Object should be enabled",
						"Object is not enabled", "Fail");
				return false;
			}
			Reporter.fnWriteToHtmlOutput("Check if object with description  "
					+ strDesc + " is enabled", "Object should be enabled",
					"Object is enabled", "Pass");
			return true;

		} catch (Exception e) {
			Reporter.fnWriteToHtmlOutput("Check if object with description  "
					+ strDesc + " is enabled", "Exception Occured",
					"Exception: " + e, "Fail");
			return false;
		}
	}
		...
		try {
			...
			while (!(bIsNotEnabled) && (intCount <= 10)) {
				try {
					...
					Reporter.fnWriteToHtmlOutput(
							"Check if object with description  " + strDesc
									+ " is disabled", "Exception occurred",
							"Exception :" + e, "Fail");
					e.printStackTrace();
					return false;
				}
			...
			if (!(bIsNotEnabled)) {
				Reporter.fnWriteToHtmlOutput(
						"Check if object with description  " + strDesc
								+ " is disabled", "Object should be disabled",
						"Object is not disabled", "Fail");
				return false;
			}
			Reporter.fnWriteToHtmlOutput("Check if object with description  "
					+ strDesc + " is disabled", "Object should be disabled",
					"Object is disabled", "Pass");
			return true;

		} catch (Exception e) {
			Reporter.fnWriteToHtmlOutput("Check if object with description  "
					+ strDesc + " is disabled", "Exception Occured",
					"Exception: " + e, "Fail");
			return false;
		}
	}
		...
		try {
			...
			if (objClick.isEnabled()) {
				...
				Reporter.fnWriteToHtmlOutput("Check if object is enabled "
						+ strDesc, "Object with description " + strDesc
						+ " should be enabled", "Object is not enabled", "Fail");
				return false;
			}

			Reporter.fnWriteToHtmlOutput("Click object matching description "
					+ strDesc, "Click operation should be successful",
			...
			e.printStackTrace();
			Reporter.fnWriteToHtmlOutput("Click object matching description "
					+ strDesc, "Click operation failed",
	...
	// *****************************************************************************************
	// * Name : fGuiScroll
	// * Description : Scroll till end of screen
	// * Author : Yogesh Patil
	// * Input Params : nil
	// * Return Values : Boolean - Depending on the success
	// *****************************************************************************************

	public boolean fGuiScroll() {
		System.out.println("Into scroll ");
		Dimension dimensions = ((AndroidDriver) driver).manage().window()
				.getSize();
	...
	public boolean fGuiClick(WebElement objClick) {
		try {
			...
			e.printStackTrace();
			Reporter.fnWriteToHtmlOutput("Click object matching description "
					+ objClick.toString(), "Click operation failed",
					"Exception occured while click object", "Fail");
			return false;
		}
	}
		...
		try {
			...
			Reporter.fnWriteToHtmlOutput(
					"Set value in object with description " + strDesc, "Value "
							+ strText + " should be set in the edit box",
					"Value is set in the text field", "Done");
			return true;
		} catch (Exception e) {
			Reporter.fnWriteToHtmlOutput(
					"Set value in object with description " + strDesc, "Value "
	...
	public boolean fValidatePageDisplayed(String strExpectedTitle) {
		...
		// while(!((strActualTitle.equalsIgnoreCase(strExpectedTitle)) ||
		// (intCount >= 31)))
		...
		if (!(driver.getTitle().equalsIgnoreCase(strExpectedTitle))) {
			Reporter.fnWriteToHtmlOutput("Validate Title", "Title should be "
					+ strExpectedTitle, "Title is " + strActualTitle, "Fail");
			return false;
		}

		// Reporter.fnWriteToHtmlOutput("Validate Title", "Title should be " +
		// strTitle, "Title is " + strActualTitle, "Pass");
		Reporter.fnWriteToHtmlOutput("Validate Title", "Title should be "
				+ strExpectedTitle, "Title is " + strActualTitle, "Pass");
		return true;
	}
	...
	public boolean fGuiSelectOptionFromList(String strDesc, String strText) {
		try {
			...
			Thread.sleep(500);
			Reporter.fnWriteToHtmlOutput("Select value from dropdown",
					"Select value " + strText,
					"Value " + strText + " selected", "Done");
			return true;

		} catch (Exception e) {
			Reporter.fnWriteToHtmlOutput(
					"Select value from dropdown with description " + strDesc,
					"Select value " + strText, "Exception " + e
							+ "occured while selecting the value", "Fail");
			return false;
		}
	}
	...
	public WebElement getObject(String objDesc) {
		...
		try {
			...
			if (strElement.equalsIgnoreCase("linktext")) {
				...
				Reporter.fnWriteToHtmlOutput("Get object matching description "
						+ objDesc, "Object should be found and returned",
						"Property " + FindBy
								+ " specified for object is invalid", "Fail");
				System.out.println("Property name " + FindBy
	...
	// *****************************************************************************************
	/*
	 * public AndroidElement getObjectAndroid(String objDesc) { //Delimiters
	 * String[] delimiters = new String[] {":="}; String[] arrFindByValues =
	 * objDesc.split(delimiters[0]);
	 * 
	 * //Get Findby and Value String FindBy = arrFindByValues[0]; String val =
	 * arrFindByValues[1];
	 * 
	 * try { //Handle all FindBy cases String strElement = FindBy.toLowerCase();
	 * if (strElement.equalsIgnoreCase("linktext")) { return
	 * driver.findElement(By.linkText(val)); } else if
	 * (strElement.equalsIgnoreCase("partiallinktext")) { return
	 * driver.findElement(By.partialLinkText(val)); } else if
	 * (strElement.equalsIgnoreCase("xpath")) { return
	 * driver.findElement(By.xpath(val)); } else if
	 * (strElement.equalsIgnoreCase("name")) { return
	 * driver.findElement(By.name(val)); } else if
	 * (strElement.equalsIgnoreCase("id")) { return
	 * driver.findElement(By.id(val)); } else if
	 * (strElement.equalsIgnoreCase("classname")) { return
	 * driver.findElement(By.className(val)); } else if
	 * (strElement.equalsIgnoreCase("cssselector")) { return
	 * driver.findElement(By.cssSelector(val)); } else if
	 * (strElement.equalsIgnoreCase("AndroidUIAutomator")) { return
	 * driver.findElement(By.tagName(val)); } else if
	 * (strElement.equalsIgnoreCase("tagname")) { return
	 * driver.findElement(By.tagName(val)); } else if
	 * (strElement.equalsIgnoreCase("accessibility_id")) { return
	 * (driver).findElement(By.id(val)); } else if
	 * (strElement.equalsIgnoreCase("appclassname")) { return
	 * (driver).findElement(By.className(val)); } else {
	 * Reporter.fnWriteToHtmlOutput("Get object matching description " +
	 * objDesc, "Object should be found and returned", "Property " + FindBy +
	 * " specified for object is invalid", "Fail");
	 * System.out.println("Property name " + FindBy + " specified for object " +
	 * objDesc + " is invalid"); return null; }
	 * 
	 * }
	 * 
	 ...
	 * "Unable to find required object", "Fail");
	 * System.out.println("Exception " + e.toString() +
	 * " occured while fetching the object"); return null; }
	 * 
	 * }
	 */
	...
	public List<WebElement> getObjects(String objDesc) {
		...
		try {
			...
			if (strElement.equalsIgnoreCase("linktext")) {
				...
				Reporter.fnWriteToHtmlOutput(
						...
						"Object List should be found and returned", "Property "
								+ FindBy + " specified for object is invalid",
						"Fail");
				System.out.println("Property name " + FindBy
		...
		// Catch Block
			...
			Reporter.fnWriteToHtmlOutput("Get objects matching description "
					+ objDesc, "Object should be found and returned",
					"Unable to find required object", "Fail");
			System.out.println("Exception " + e.toString()
					+ " occured while fetching the object");
	...
	// *****************************************************************************************
	// * Name : getChildObject
	// * Description : Returns the child element of webelement based on the
	// description
	// * Author : Aniket Gadre
	// * Input Params : objParent - Parent WebElement
	...
	public WebElement getChildObject(WebElement parentElem, String objDesc) {
		...
		try {
			...
			if (strElement.equalsIgnoreCase("linktext")) {
				...
				Reporter.fnWriteToHtmlOutput(
						"Get child object matching description " + objDesc,
						"Object should be found and returned", "Property "
								+ FindBy + " specified for object is invalid",
						"Fail");
				System.out.println("Property name " + FindBy
						+ " specified for object " + objDesc + " is invalid");
		...
		try {
			...
			if (objChkBox.isEnabled()) {
				...
				if (objChkBox.isSelected()) {
					Reporter.fnWriteToHtmlOutput(
							"Click object matching description " + strDesc,
							"Check operation should be successful",
							"Object is disabled and already checked", "Done");
					return true;
				}
				Reporter.fnWriteToHtmlOutput("Check if object is enabled "
						+ strDesc, "Object with description " + strDesc
			...
			Reporter.fnWriteToHtmlOutput("Click object matching description "
					+ strDesc, "CHeck operation should be successful",
					"Successfully checked the checkbox", "Done");
			return true;

		} catch (Exception e) {
			e.printStackTrace();
			Reporter.fnWriteToHtmlOutput("Click object matching description "
					+ strDesc, "Checking checkbox operation failed",
					"Exception occured while checking check box", "Fail");
			return false;
		}
	}
	...
	public boolean fGuiUncheckCheckBox(String strDesc) {
		try {
			...
			Reporter.fnWriteToHtmlOutput("Click object matching description "
					+ strDesc, "Uncheck operation should be successful",
					"Successfully unchecked the checkbox", "Done");
			return true;

		} catch (Exception e) {
			e.printStackTrace();
			Reporter.fnWriteToHtmlOutput("Click object matching description "
					+ strDesc, "Unchecking checkbox operation failed",
					"Exception occured while unchecking check box", "Fail");
			return false;
		}
	}
	...
	public boolean setGeoLocation(String lat, String lon) {
		try {
			String Script = "window.navigator.geolocation.getCurrentPosition =  function(success){var position = {'coords' : {'latitude': '"
					+ lat
					+ "', 'longitude': '"
					+ lon
					+ "'}}; success(position);}";
			...
			Reporter.fnWriteToHtmlOutput("Set geo location",
					"Should be set successfully",
					"Setting geo location failed. Exception " + e, "Fail");
			return false;
		}
		// return
		return true;
	...
	public String getCurrentBrowser() {
		try {
			...
			Reporter.fnWriteToHtmlOutput("Get browser name",
					"Should return Browser Name",
					"Fetching Browser Name Failed. Exception " + e, "Fail");
			return "";
		}
	}
	...
	public boolean switchToWindowWithName() {
		try {
			...
			Reporter.fnWriteToHtmlOutput("Switch Window",
					"Switch to new Window ", "Exception occured : " + e, "Fail");
			return false;
		}
	...
	public boolean fverifyCheckBoxIsChecked(String strDesc) {
		try {
			...
			if (objChkBox.isSelected()) {
				// Reporter.fnWriteToHtmlOutput("Check is checkbox is checked with description "
				// + strDesc, "CHeckbox should be  checked",
				// "Checkbox is checked", "Done");
				return true;
			...
			e.printStackTrace();
			Reporter.fnWriteToHtmlOutput(
					"Verify is checkbox is checked with description " + strDesc,
					"Verifying checkbox is checked operation failed",
					"Exception occured while checking check box", "Fail");
			return false;
		}
	}
	...
	public boolean fverifyCheckBoxIsUnchecked(String strDesc) {
		try {
			...
			e.printStackTrace();
			Reporter.fnWriteToHtmlOutput(
					"Verify is checkbox is unchecked with description "
							+ strDesc,
					"Verifying checkbox is checked operation failed",
					"Exception occured while checking check box", "Fail");
			return false;
	...
	// * Description : returns current time stamp
	// * Author : Aniket Gadre
	// * Input Params : strDesc - The description of the object to clicks
	// * Return Values : Boolean - Depending on the success
	// *****************************************************************************************
	...
	// * Return Values : Boolean - Depending on the success
	// ***************
	public boolean fGuiHideKeyBoard() {
	...
	// *****************************************************************************************
	// * Name : fGuiLongPress()
	// * Description : long press in order to perform some actions
	// * Author : Yogesh Patil
	// * Input Params : stringDescrip (ID only)
	// * Return Values : void
	// ***************
	public void fGuiLongPress(String strDesc) {

		String pressAction = strDesc.replaceAll("id:=", "");
		TouchAction Action = new TouchAction((AndroidDriver) driver);
		Action.longPress(driver.findElement(By.id(pressAction))).perform();

		// System.out.println("LONG PRESS"+strDesc.split("="));

		/*
		 * String press = null; String[] delimiters = new String[] {":="};
		 * String[] arrFindByValues = objDesc.split(delimiters[0]);
		 * 
		 * //Get Findby and Value String FindBy = arrFindByValues[0]; String val
		 * = arrFindByValues[1]; String strElement = FindBy.toLowerCase();
		 * 
		 * if (strElement.equalsIgnoreCase("id")) { press=
		 * driver.findElement(By.id(val)); }
		 */

		/*
		 * String abc=new
		 * String("new UiScrollable(new UiSelector().scrollable(true)" +
		 * ".instance(0)).scrollIntoView(new UiSelector()" +
		 * ".textContains(\"MILJONLOTTERIET\").instance(0))");
		 * abc.replaceAll("MILJONLOTTERIET", strDesc);
		 * ((AndroidDriver)driver).findElementByAndroidUIAutomator(abc);
		 */
	...
	// *****************************************************************************************
	// * Name : fGuiBackPress()
	// * Description : back press
	// * Author : Yogesh Patil
	// * Input Params : nil
	// * Return Values : Boolean - Depending on the success
	// ***************
	public boolean fGuiBackPress() {
	...
	// *****************************************************************************************
	// * Name : fGuiloginwithFOrexid()
	// * Description : login
	// * Author : Girishesh and Gaurav Valera
	// * Input Params : login method ID
	// * Return Values : Boolean - Depending on the success
	// ***************

	public void fGuilogin(String loginmethod) {
		// driver.findElement(By.xpath("spinner_text")).click();
		driver.findElement(
				By.xpath("//android.widget.TextView[contains(@resource-id,'spinner_text')]"))
				.click();
		driver.findElement(By.name(loginmethod)).click();
	...
	// * Name : fGuidragdrop()
	// * Description : logout
	// * Author : Gaurav Valera
	// * Input Params : nil
	// * Return Values : Boolean - Depending on the success
	// ***************
	public boolean fGuidragdrop(String resourceId, int sourceIndex,
			int destinationIndex) {
		new TouchAction((AndroidDriver) driver)
				.longPress(
						(WebElement) driver.findElements(By.id(resourceId))
								.get(sourceIndex))
				.moveTo((WebElement) driver.findElements(By.id(resourceId))
						.get(destinationIndex)).release().perform();
		return true;
	}
	...
	// * Return Values : Boolean - Depending on the success
	// ***************
	public boolean fGuiuninstall() {
		((AndroidDriver) driver).closeApp();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		((AndroidDriver) driver).removeApp("se.forex.android.mobilbank.test");
		return true;
	}

	// *****************************************************************************************
	// * Name : fGuiRandomNumber()
	// * Description : To generate random number
	// * Author : pruendra Singh
	// * Input Params : nil
	// * Return Values : Boolean - Depending on the success
	// ******************************************************************************************
	
	 public static final String fGuiRandomNumber() {
		Random rand = new Random();
		Integer pick = (rand.nextInt(8) + 1);
		String abc = pick.toString();
		System.out.println(abc.toString());
		return abc;		
	 }
//		 Random randomGenerator = new Random();
//		    Random rand = new Random();
//			Integer pick = (rand.nextInt(99) + 1);
//			
//		    System.out.println(pick.to;
//		  }
//		  
