...
public class TestsForGmailCleanUp {	
	  ...
	  {
		  System.out.println("Before Class Test for Gmail Cleanup");
	   ...
	   @Test
	   public void TestsForGmailCleanUp()
	   {
		   System.out.println("testGMailCleanup");		   
